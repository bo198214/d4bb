...
public class PolyhedronBoundaryComplexTests {
    ...
    [Test] public void Polyhedron3dBoundaryComplex_Links() {
        ...
        var frontInCube  = cube.d2faces.First(f => f.Equals(front));
        var bottomInCube = cube.d2faces.First(f => f.Equals(bottom));
        var leftInCube   = cube.d2faces.First(f => f.Equals(left));
    ...
    [Test] public void Polyhedron3dBoundaryComplex_TwoCubes_Numbers() {
        // Default showGridDivisions=true: the 4 grid lines where the two cubes meet on
        ...
        // showGridDivisions=false hides those 4 grid lines — back to the legacy count of 16.
        var cubesNoGrid = new Polyhedron3dBoundaryComplex(
            new int[][]{new int[]{0,0,0},new int[]{1,0,0}},
            cam: null, showIntraCoplanarEdges: false, showGridDivisions: false);
    ...
    [Test] public void Polyhedron3dBoundaryComplex_TwoCubes_Links() {
        ...
        var front1InComplex = cubes.d2faces.First(f => f.Equals(front1));
        var front2InComplex = cubes.d2faces.First(f => f.Equals(front2));
